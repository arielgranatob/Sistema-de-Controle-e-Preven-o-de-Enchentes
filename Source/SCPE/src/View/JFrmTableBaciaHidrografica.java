 ...
 * @author italo
 */
public class JFrmTableBaciaHidrografica extends javax.swing.JFrame {

    private String sql;
    private Connection conn;

    public JFrmTableBaciaHidrografica() {
        super("Bacias Hidrograficas");
        initComponents();
        Connection con;
        con = Conexao.conexao();
        carregarDados();
    ...
    private void initComponents() {
        ...
        jTableBaciaHidrografica = new javax.swing.JTable();
        ...
        jTableBaciaHidrografica.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTableBaciaHidrografica);
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        JFrmCadastroBaciaHidrografica jFrmCadastroBaciaHidrografica = new JFrmCadastroBaciaHidrografica(this);
        jFrmCadastroBaciaHidrografica.setVisible(true);
    }//GEN-LAST:event_jButtonNovoActionPerformed

    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        int linhaSelecionada = jTableBaciaHidrografica.getSelectedRow();
        Object[] opcoes = {"SIM", "NÃO"};
        if (linhaSelecionada < 0) {
            JOptionPane.showMessageDialog(rootPane, "POR FAVOR SELECIONE A LINHA QUE DESEJA EXCLUIR", "", 1);
        } else {
            int codBaciaHidrografica = (int) jTableBaciaHidrografica.getValueAt(linhaSelecionada, 0);
            ...
            if (confirmaDelete == 0) {
                ...
                baciahidrografica.setId(codBaciaHidrografica);
                BaciasHidrograficasDAO baciahidrograficadao = new BaciasHidrograficasDAO();
                baciahidrograficadao.delete(baciahidrografica);
                carregarDados();
            }
        }
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        if (linhaSelecionada < 0) {
            ...
            int codAluno = (int) jTableBaciaHidrografica.getValueAt(linhaSelecionada, 0);
            JFrmEditarBaciaHidrografica editarBacia = new JFrmEditarBaciaHidrografica(codAluno, this);
            editarBacia.setVisible(true);
        }
...
//        carregarDadosKey(jTextFieldPesquisa.getText());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmTableBaciaHidrografica().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTableBaciaHidrografica;
    ...
    public void carregarDados() {
        ...
        BaciasHidrograficasDAO arrayBaciaHidrograficaDAO = new BaciasHidrograficasDAO();
        //Preenche o arrayPessoas com objetos do tipo PESSOA retornados pela função consulta do PessoasDAO
        arrayBaciaHidrografica = arrayBaciaHidrograficaDAO.consulta(sql);
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"#", "NOME", "ÁREA"}, 0);
        for (int i = 0; i < arrayBaciaHidrografica.size(); i++) {
            Object dados[] = {
                arrayBaciaHidrografica.get(i).getId(),
                arrayBaciaHidrografica.get(i).getNome(),
                arrayBaciaHidrografica.get(i).getArea(),};
            modelo.addRow(dados);
        }
        // Faz chamada da função criarTabela passando como parâmetro o modelo criado
        jTableBaciaHidrografica.setModel(modelo);
    }
