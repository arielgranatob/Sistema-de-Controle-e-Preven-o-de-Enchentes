 ...
 * @author italo
 */
public class JFrmTableRio extends javax.swing.JFrame {

    private String sql;
    private Connection conn;

    public JFrmTableRio() {
        super("Rios Cadastrados");
        initComponents();
        Connection con;
        con = Conexao.conexao();
        carregarDados();
    ...
    private void initComponents() {
        ...
        jTableRio = new javax.swing.JTable();
        ...
        jTableRio.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "#", "ENDEREÇO", "BACIA HIDOGRAFICA", "NOME RIO"
            }
        ) {
        ...
        jScrollPane1.setViewportView(jTableRio);
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        JFrmCadastroRio jFrmCadastroRio = new JFrmCadastroRio(this);
        jFrmCadastroRio.setVisible(true);
    }//GEN-LAST:event_jButtonNovoActionPerformed

    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        int linhaSelecionada = jTableRio.getSelectedRow();
        Object[] opcoes = {"SIM", "NÃO"};
        if (linhaSelecionada < 0) {
            JOptionPane.showMessageDialog(rootPane, "POR FAVOR SELECIONE A LINHA QUE DESEJA EXCLUIR", "", 1);
        } else {
            int codRio = (int) jTableRio.getValueAt(linhaSelecionada, 0);
            int confirmaDelete = JOptionPane.showOptionDialog(null, "DESEJA REALMENTE DELETAR OS DADOS DO RIO SELECIONADO?", "", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, opcoes, opcoes[0]);
            if (confirmaDelete == 0) {
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        if (linhaSelecionada < 0) {
            ...
            int codRio = (int) jTableRio.getValueAt(linhaSelecionada, 0);
            JFrmEditarRio editarAluno = new JFrmEditarRio(codRio, this);
...
//        carregarDadosKey(jTextFieldPesquisa.getText());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmTableRio().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable jTableRio;
    ...
    public void carregarDados() {
        ...
        String sql = "SELECT rio.*, endereco.*, baciaHidrografica.* FROM rio, endereco, baciaHidrografica WHERE rio.idEndereco=endereco.idEndereco AND rio.idBaciaHidografica=baciaHidrografica.idBaciaHidografica";
        ...
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"#", "ENDEREÇO", "BACIA HIDROGRAFICA", "NOME RIO"}, 0);
        for (int i = 0; i < arrayRios.size(); i++) {
            Object dados[] = {
                arrayRios.get(i).getId(),
                arrayRios.get(i).getNomeEndereco(),
                arrayRios.get(i).getNomeBaciaHidrografica(),
                arrayRios.get(i).getNome()
            };
            modelo.addRow(dados);
        }
        // Faz chamada da função criarTabela passando como parâmetro o modelo criado
        jTableRio.setModel(modelo);
    }
