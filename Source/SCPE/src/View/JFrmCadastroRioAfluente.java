 ...
 * @author italo
 */
public class JFrmCadastroRioAfluente extends javax.swing.JFrame {

    private String sql;
    private Connection conn;
    JFrmCadastroRioAfluente listarAlunos = null;

    /**
     * Creates new form JFrmCadastroAluno
     */
    public JFrmCadastroRioAfluente() {
        initComponents();
        this.setLocationRelativeTo(null);

    }

    JFrmCadastroRioAfluente(JFrmCadastroRioAfluente listarAlunos) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("CADASTRAR RIO AFLUENTE");
...
//        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmCadastroRioAfluente.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmCadastroRioAfluente().setVisible(true);
