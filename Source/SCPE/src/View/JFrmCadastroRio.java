 ...
 * @author italo
 */
public class JFrmCadastroRio extends javax.swing.JFrame {
     ...
     */
    public JFrmCadastroRio() {
        initComponents();
        this.setLocationRelativeTo(null);

    }

    JFrmCadastroRio(JFrmTableRio listarRios) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("CADASTRAR RIO");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(jComboBoxBaciaHidrografica, 0, 220, Short.MAX_VALUE)
    ...
    private void jButtonCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCadastrarActionPerformed
        ...
        System.out.println(codigoEndereco);
        ...
        //SALVAR A VARIAVEL AQUI NO BANCO
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmCadastroRio.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmCadastroRio().setVisible(true);
