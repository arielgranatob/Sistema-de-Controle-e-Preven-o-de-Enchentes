 ...
 * @author italo
 */
public class JFrmTableEnchente extends javax.swing.JFrame {

    private String sql;
    private Connection conn;

    public JFrmTableEnchente() {
        super("Enchentes Cadastradas");
        initComponents();
        Connection con;
        con = Conexao.conexao();
        carregarDados();
    ...
    private void initComponents() {
        ...
        jTableAluno.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "ENDEREÇO", "RIO", "DATA ENCHENTE", "ESTAÇÃO ENCHENTE"
            }
        ) {
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        JFrmCadastroEnchente jFrmCadastroEnchente = new JFrmCadastroEnchente(this);
        jFrmCadastroEnchente.setVisible(true);
...
//        }
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        ...
        JFrmEditarEnchente editarEnchente = new JFrmEditarEnchente();
        editarEnchente.setVisible(true);
...
//        carregarDadosKey(jTextFieldPesquisa.getText());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmTableEnchente().setVisible(true);
            }
        });
    }
