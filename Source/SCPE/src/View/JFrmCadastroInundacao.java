 ...
 * @author italo
 */
public class JFrmCadastroInundacao extends javax.swing.JFrame {

    private String sql;
    private Connection conn;
    JFrmCadastroInundacao listarAlunos = null;

    /**
     * Creates new form JFrmCadastroAluno
     */
    public JFrmCadastroInundacao() {
        initComponents();
        this.setLocationRelativeTo(null);

    }

    JFrmCadastroInundacao(JFrmCadastroInundacao listarAlunos) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("CADASTRAR INUNDAÇÃO");
...
//        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmCadastroInundacao.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmCadastroInundacao().setVisible(true);
