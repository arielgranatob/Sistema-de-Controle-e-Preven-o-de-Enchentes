 ...
 * @author italo
 */
public class JFrmTableInundacao extends javax.swing.JFrame {

    private String sql;
    private Connection conn;

    public JFrmTableInundacao() {
        super("Inundações Cadastradas");
        initComponents();
        Connection con;
        con = Conexao.conexao();
        carregarDados();
    ...
    private void initComponents() {
        ...
        jTableAluno.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "ENDEREÇO", "RIO", "DATA INUNDAÇÃO", "ESTAÇÃO INUNDAÇÃO"
            }
        ) {
    ...
    private void jButtonNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNovoActionPerformed
        JFrmCadastroInundacao jFrmCadastroInundacao = new JFrmCadastroInundacao();
        jFrmCadastroInundacao.setVisible(true);
...
//        }
    ...
    private void jButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditarActionPerformed
        JFrmEditarInundacao editarInundacao = new JFrmEditarInundacao();
        editarInundacao.setVisible(true);
...
//        carregarDadosKey(jTextFieldPesquisa.getText());
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmTableInundacao().setVisible(true);
            }
        });
    }
