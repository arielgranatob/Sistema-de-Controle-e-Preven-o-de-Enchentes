 ...
 * @author italo
 */
public class JFrmEditarEnchente extends javax.swing.JFrame {

    private String sql;
    private Connection conn;
    JFrmEditarEnchente listarAlunos = null;

    /**
     * Creates new form JFrmCadastroAluno
     */
    public JFrmEditarEnchente() {
        initComponents();
        this.setLocationRelativeTo(null);

    }

    JFrmEditarEnchente(JFrmEditarEnchente listarAlunos) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("EDITAR ENCHENTE");
...
//        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrmEditarEnchente.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrmEditarEnchente().setVisible(true);
